export class Bank {
  constructor(maxCapacity) {
    ...
    this.totalServed = 0;            // Общее число обслуженных клиентов
    this.isWindingDown = false;      // Фаза завершения работы
  }
}
...
export class Client {
  ...
  constructor() {
    ...
    this.patience = 20000 + Math.random() * 30000; // Время до ухода (20-50 сек)
